                ...
                <li>
                    ...
                    <script type="text/javascript">
                            SimpleJekyllSearch.init({
                                ...
                                searchResultTemplate: '<li><a href="https://www.cdslab.org/python{url}" title="">{title}</a></li>',
...
$(document).ready(function() {
  ...
  $('input#search').on('input', function () {
    ...
    if (!this.value || this.value.trim() == '') {
      ...
      $('#s-tags-div').html('');
      $('#search-results').html('<h2 style="background:#ad141e;border-radius: 20px;margin-bottom: 56px;color: white;" class="post_title">Found 0 result(s)</h2> ');
...
<i class="fa fa-circle-thin fa-stack-2x"></i>
        ...
        <div class="col-lg-12 footer">
            ...
            Site last generated: September 18, 2025 <br />
